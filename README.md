...
This script processes MRI-derived metrics (FA, MD, T1, T2, T2*) across deep gray matter regions and correlates them with forehead temperature measurements taken during scanning.
